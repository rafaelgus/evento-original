                                        ...
                                        <div class="item-inner">
                                            <div class="item-img">
                                                <div class="item-img-info">
                                                    <a href='{{ "/diseñar-papel-comestible-desde-cero/" .  $variant->getId() }}' title="{{ $variant->getName() }}" class="product-image">
                                            ...
                                            <div class="item-info">
                                                <div class="info-inner">
                                                    <div class="item-title"><a title="{{ $variant->getName() }}" href='{{ "/diseñar-papel-comestible-desde-cero/" .  $variant->getId() }}'> {{ $variant->getName() }} </a></div>
