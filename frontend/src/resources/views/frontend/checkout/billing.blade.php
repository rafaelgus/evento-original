                        ...
                        <li id="opc-billing" class="section allow active">
                            ...
                            <div id="checkout-step-billing" class="step a-item" style="">
                                ...
                                <fieldset class="group-select">
                                        ...
                                        <li id="billing-new-address-form">
                                            <fieldset>
                                                ...
                                                <ul>
                                                    <li>
                                                        <div class="customer-name">
                                                            <div class="input-box name-firstname">
                                                                <label for="billing:firstname">{{ trans('frontend/checkout.name')}}
                                                                    <span class="required">*</span> </label>
                                                                <br>
                                                                <input type="text" id="name" name="name"
                                                                       value="{{ old('name', $customer->getFirstName()) }}"
                                                                       title="First Name"
                                                                       class="input-text required-entry" required>
                                                            </div>
                                                            <div class="input-box name-lastname">
                                                                <label for="billing:lastname"> {{ trans('frontend/checkout.lastName') }}
                                                                    <span class="required">*</span> </label>
                                                                <br>
                                                                <input type="text" id="lastName" name="lastName"
                                                                       value="{{old('lastName', $customer->getLastName())}}"
                                                                       title="Last Name"
                                                                       class="input-text required-entry" required>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <li>
                                                        <div class="input-box">
                                                            <label for="billing:telephone">{{trans('frontend/checkout.phone')}}
                                                                <span class="required">*</span></label>
                                                            <br>
                                                            <input type="text" id="telephone" name="telephone"
                                                                   value="{{ old('phoneNumber', $customer->getPhoneNumber()) }}"
                                                                   title="Telephone" class="input-text required-entry"
                                                                   id="billing:telephone" required>
                                                        </div>
                                                    </li>
                                                    <li>
                                                        <label for="billing-address-select">Seleccione una
                                                            direccion</label>
                                                        <br>
                                                        <select name="addressId" id="billing-address-select" required
                                                        ...
                                                        <button type="button" class="button continue"
                                                                onclick="showFormAddress();"><span>Nueva</span></button>
                                                        <input type="hidden" value="0" name="newAddress"
                                                               id="newAddress">
                                                    </li>
                                                    <div id="newAddressForm" style="display: none;">
                                                        <li>
                                                            <div class="input-box">
                                                                <label for="billing:city">{{trans('frontend/checkout.address')}}
                                                                    <span class="required">*</span></label>
                                                                <br>
                                                            ...
                                                            <div class="input-box">
                                                                <label for="billing:city">{{trans('frontend/checkout.city')}}
                                                                    <span class="required">*</span></label>
                                                                <br>
                                                            ...
                                                            <div id="" class="input-box">
                                                                <label for="billing:region">{{trans('frontend/checkout.state')}}
                                                                    <span class="required">*</span></label>
                                                                <br>
                                                                <input type="text" name="state"
                                                                       class="input-text required-entry">
                                                                <input type="text" id="province" name="billing[region]"
                                                                       value="Alabama" title="State/Province"
                                                                       class="input-text required-entry"
                                                                       style="display: none;">
                                                            </div>
                                                        </li>
                                                        <li>
                                                            <div class="input-box">
                                                                <label for="billing:postcode">{{ trans('frontend/checkout.postal-code')  }}
                                                                    <span class="required">*</span></label>
                                                                <br>
                                                                <input type="text" title="Zip/Postal Code"
                                                                       name="postalCode" id="postalCode" value="46532"
                                                                       class="input-text validate-zip-international required-entry">
                                                            </div>
                                                            <div class="input-box">
                                                                <label for="billing:country_id">{{trans('frontend/checkout.country')}}
                                                                    <span class="required">*</span></label>
                                                                <br>
                                    ...
                                    <button type="button" onclick="postForm()" class="button continue">
                                        <span>{{ trans('buttons.continue') }}</span></button>
                                </fieldset>
                            </div>
                        </li>
    ...
    <script>
        ...
        function postForm() {
            ...
            if (newAddress === "0") {
                ...
                if (name === '' || lastName === '' || telephone === '' || addressBox === '' ||
