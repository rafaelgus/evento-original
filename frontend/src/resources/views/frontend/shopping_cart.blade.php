                            ...
                            <fieldset>
                                <table class="data-table cart-table" id="shopping-cart-table">
                                    ...
                                    <tr class="first odd">
                                        ...
                                        <td class="a-right movewishlist"><span class="cart-price"> <span class="price">$ {{($item['price'] * $item['qty'])/ 100}}</span></span></td>
                                ...
                                <div class="inner">
                                    <table class="table shopping-cart-table-total" id="shopping-cart-totals-table">
                                        ...
                                        <tr>
                                            ...
                                            <td class="a-right" style=""><strong><span class="price">${{ ($total / 100 )}}</span></strong></td>
                                        </tr>
                                        </tfoot>
                                    </table>
                                    <ul class="checkout">
