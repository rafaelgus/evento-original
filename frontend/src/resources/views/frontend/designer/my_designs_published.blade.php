            ...
            <div class="row">
                <div class="col-xs-12">
                    <ul>
                        ...
                        <li class="category1601"><strong>{{ trans('designer.my_designs_published.title') }}</strong></li>
                    </ul>
                </div>
            </div>
        </div>
                ...
                <div class="col-sm-9">
                    ...
                    <div class="state_bar">
                        <ul id="checkout-progress-state" class="checkout-progress">
                            ...
                            <li class="active first"><a href="{{route('designer.myDesignsPublished')}}">{{ trans('designer.status.published') }}</a></li>
                        </ul>
                    </div>

                    <a href="{{ route('designer.create') }}" class="button link-button">{{ trans('designer.new_design') }}</a>

                    <p>{{ trans('designer.my_designs_published.description') }}</p>
