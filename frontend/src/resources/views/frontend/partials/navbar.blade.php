    ...
    <div class="container">
        ...
        <div class="nav-inner">
            ...
            <ul id="nav" class="hidden-xs">
                <li class="level0 parent drop-menu" id="nav-home"><a href="/" class="level-top"><span>{{ trans('sections.home') }}</span></a>
                </li>
                <li class="mega-menu"> <a class="level-top" href="/{{ str_slug(trans('sections.mugs')) }}" > <span>{{ trans('sections.mugs') }}</span> </a>
