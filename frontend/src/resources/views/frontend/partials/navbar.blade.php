                    ...
                    <div class="level0-wrapper dropdown-6col">
                        <div class="container">
                            <div class="level0-wrapper2">
                                <div class="nav-add"> <a href="#"><img src="images/menu-banner.jpg" alt="download"> </a> </div>
                                <div class="nav-block nav-block-center">
                                    <!--mega menu-->
                                    <ul class="level0">
                                        <li class="level3 nav-6-1 parent item"> <a href="grid.html"><span>Stylish bag</span></a>
                                            <ul class="level1">
                                        ...
                                        <li class="level3 nav-6-1 parent item"> <a href="grid.html"><span>shoes</span></a>
                                            <ul class="level1">
                                                ...
                                                <li class="level2 nav-6-1-1"> <a href="grid.html"><span>Crocs Shoes</span></a> </li>
                                            </ul>
                                        </li>
                                        <li class="level3 nav-6-1 parent item"> <a href="grid.html"><span>jwellery</span></a>
                                            <ul class="level1">
                                        ...
                                        <li class="level3 nav-6-1 parent item"> <a href="grid.html"><span>swimwear</span></a>
                                            <ul class="level1">
                    ...
                    <div class="level0-wrapper dropdown-6col">
                        <div class="container">
                            <div class="level0-wrapper2">
                                <div class="nav-block nav-block-center">
                                    <div class="col-2">
                                        <div class="menu_image1"> <a title="" href="#"><img alt="menu_image" src="images/watch.png"> </a> </div>
                                    </div>
                                    ...
                                    <div class="col-1">
                                        <ul class="level0">
                                            ...
                                            <li class="level1 nav-6-1 parent item"> <a href="grid.html"><span>Dresses</span></a>
                                                <ul class="level1">
                                                    <li class="level2 nav-6-1-1"><a href="grid.html"><span>Casual Dresse</span></a></li>
                                                    <li class="level2 nav-6-1-1"><a href="grid.html"><span>Evening</span></a></li>
                                                    <li class="level2 nav-6-1-1"><a href="grid.html"><span>Designer</span></a></li>
                                                    <li class="level2 nav-6-1-1"><a href="grid.html"><span>Party</span></a></li>
                                                </ul>
