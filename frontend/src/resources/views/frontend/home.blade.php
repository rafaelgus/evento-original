                                                ...
                                                <ul class="products-grid">
                                                    ...
                                                    <li class="item col-lg-3 col-md-3 col-sm-4 col-xs-6">
                                                        <div class="item-inner">
                                                            <div class="item-img">
                                                                <div class="item-img-info"> <a class="product-image" title="Maharaja 450W Juicer" href="/articulo/detalle"> <img alt="Maharaja 450W Juicer" src="/article/storage/{{(count($article->getImages()) > 0)? $article->getImages()->toArray()[0]->getPath(): 'hola' }}"> </a>
                                                                    <div class="box-hover">
                                                            ...
                                                            <div class="item-info">
                                                                <div class="info-inner">
                                                                    <div class="item-title"> <a title="Maharaja 450W Juicer" href="/articulo/detalle"> {{$article->getShortDescription()}} </a> </div>
