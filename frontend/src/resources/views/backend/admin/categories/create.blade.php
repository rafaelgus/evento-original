                    ...
                    <form role="form" class="form-horizontal" action="/management/category" method="POST">
                        <div class="box-body">
                            ...
                            <div class="form-group {{ $errors->has('name') ? 'has-error' : '' }}">
                                <label for="inputName"
                                       class="col-sm-2 control-label">{{ trans('texts.sections.categories.name') }}</label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="inputName" name="name"
                                           placeholder="{{ trans('texts.sections.categories.name') }}"
                                           value="{{ old('name') }}">
                            ...
                            <div class="form-group {{ $errors->has('slug') ? 'has-error' : '' }}">
                                <label for="inputSlug"
                                       class="col-sm-2 control-label">{{ trans('texts.sections.categories.slug') }}</label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="inputSlug" name="slug"
                                           placeholder="{{ trans('texts.sections.categories.slug') }}"
                                           value="{{ old('slug') }}">
                            ...
                            <div class="form-group {{ $errors->has('affiliate_commission') ? 'has-error' : '' }}">
                                ...
                                <div class="col-sm-10">
                                    <input type="number" class="form-control" id="inputAffiliateCommission" name="affiliate_commission" value="5"
