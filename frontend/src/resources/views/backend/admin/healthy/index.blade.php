...
@section('header')
    ...
    <section class="content-header">
        <h1>
            {{ trans('texts.sections.healthys.title') }}
            <small>{{ trans('texts.sections.healthys.view') }}</small>
        </h1>
        <ol class="breadcrumb">
            <li><i class="fa fa-tint"></i>  {{ trans('texts.sections.healthys.title') }}</li>
            <li class="active">{{ trans('texts.sections.healthys.view') }}</li>
        </ol>
    </section>
@stop
    ...
    <section class="content">
        <div class="row">
            <div class="col-md-12">
                <div class="box">
                    <div class="box-body">
                            <table id="healthys-table" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                                <thead>
                                <tr>
                                    <th>ID</th>
                                    <th>{{ trans('texts.sections.healthys.name') }}</th>
...
@section('scripts_body')
    ...
    <script>
        $(document).ready(function (e) {
            $('#healthys-table').DataTable({
                processing: true,
                serverSide: true,
                ajax: '/management/healthy/getDatatable',
                columns: [
                    { data: 'id', name: 'id' },
                    { data: 'name', name: 'name' },
                    {
                        ...
                        "bSortable": false,
                        "bSearchable": false,
                        "mRender": function (o) { return '<a href="/management/healthy/' + o.id +'/edit" class="danger">Editar</a>'}
                    }
                ],
                language: {
