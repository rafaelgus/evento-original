        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="box box-danger">
                    <!-- form start -->
                    <form role="form" class="form-horizontal" action="/management/circular-design-variant" method="POST"
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group {{ $errors->has('name') ? 'has-error' : '' }}">
                                <label for="inputName"
                                       class="col-sm-2 control-label">{{ trans('texts.sections.circular_design_variants.name') }}</label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="inputName" name="name"
                                           placeholder="{{ trans('texts.sections.circular_design_variants.name') }}"
                                           value="{{ old('name') }}">
                            ...
                            <div class="form-group {{ $errors->has('design_material_size_id') ? 'has-error' : '' }}">
                                ...
                                <div class="col-sm-10">
                                    <select class="form-control select2" id="inputDesignMaterialSize"
                                            name="design_material_size_id">
                            ...
                            <div class="form-group {{ $errors->has('number_of_circles') ? 'has-error' : '' }}">
                                <label for="inputNumberOfCircles"
                                       class="col-sm-2 control-label">{{ trans('texts.sections.circular_design_variants.number_of_circles') }}</label>
                                <div class="col-sm-10">
                                    <input type="number" class="form-control" id="inputNumberOfCircles"
                                           name="number_of_circles"
                                           placeholder="{{ trans('texts.sections.circular_design_variants.number_of_circles') }}"
                                           value="{{ old('number_of_circles') }}">
                            ...
                            <div class="form-group {{ $errors->has('price') ? 'has-error' : '' }}">
                                ...
                                <div class="col-sm-10">
                                    <input type="number" step="0.01" class="form-control" id="inputDiameterOfCircles"
                                           name="diameter_of_circles"
                                           placeholder="{{ trans('texts.sections.circular_design_variants.diameter_of_circles') }}"
                                           value="{{ old('diameter_of_circles') }}">
                            ...
                            <div class="form-group {{ $errors->has('image') ? 'has-error' : '' }}">
                                <label for="inputImage"
                                       class="col-sm-2 control-label">{{ trans('texts.sections.circular_design_variants.image') }}</label>
                                <div class="col-sm-10">
                                    <input type="file" class="form-control" id="inputImage" name="image"
                                           placeholder="{{ trans('texts.sections.circular_design_variants.image') }}"
                                           value="{{ old('image') }}">
                        ...
                        <div class="box box-primary">
                            ...
                            <div class="box-body">
                                    ...
                                    <div id="subitem">
                                        ...
                                        <div class="col-sm-3">
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10">
                                                    <input type="number" step="0.01" class="form-control" id="inputUrl"
                                                           name="prices[]"
                                        ...
                                        <div class="col-sm-1">
                                            <button id="del"
                                                    class="del btn btn-danger glyphicon glyphicon-remove row-remove"
                                                    type="button"></button>
                                        </div>
                                ...
                                <br><br>
                                <button type="button" class="btn btn-primary pull-right" id="add-sub-item"><i
