        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="box box-danger">
                    <!-- form start -->
                    <form role="form" class="form-horizontal"  action="{{ '/management/circular-design-variant/' . $circularDesignVariant->getId() }} " method="POST">
                        <div class="box-body">
                            ...
                            <div class="form-group {{ $errors->has('name') ? 'has-error' : '' }}">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="inputName" name="name"
                                           placeholder="{{ trans('texts.sections.design_material_sizes.name') }}" value="{{ old('name', $circularDesignVariant->getName()) }}">
