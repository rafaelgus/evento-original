...
class Version20180118204528 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE payments (id INT AUTO_INCREMENT NOT NULL, order_id INT DEFAULT NULL, user_id INT DEFAULT NULL, paidDate DATETIME DEFAULT NULL, originalAmount INT NOT NULL, originalCurrency VARCHAR(255) NOT NULL, paidAmount INT DEFAULT NULL, paidCurrency VARCHAR(255) DEFAULT NULL, status VARCHAR(255) NOT NULL, gateway VARCHAR(255) NOT NULL, requestData VARCHAR(255) DEFAULT NULL, responseData VARCHAR(255) DEFAULT NULL, description VARCHAR(255) DEFAULT NULL, data TEXT DEFAULT NULL, param TEXT DEFAULT NULL COMMENT \'(DC2Type:json)\', externalId VARCHAR(255) DEFAULT NULL, UNIQUE INDEX UNIQ_65D29B328D9F6D38 (order_id), INDEX IDX_65D29B32A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
