...
class Version20170927141012 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE payment (id INT AUTO_INCREMENT NOT NULL, order_id INT DEFAULT NULL, user_id INT DEFAULT NULL, date DATETIME NOT NULL, originalAmount INT NOT NULL, originalCurrency VARCHAR(255) NOT NULL, paidAmount INT NOT NULL, paidCurrency VARCHAR(255) NOT NULL, status VARCHAR(255) NOT NULL, gateway VARCHAR(255) NOT NULL, requestData VARCHAR(255) NOT NULL, responseData VARCHAR(255) NOT NULL, description VARCHAR(255) NOT NULL, data VARCHAR(255) NOT NULL, param JSON NOT NULL, UNIQUE INDEX UNIQ_6D28840D8D9F6D38 (order_id), INDEX IDX_6D28840DA76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE customers ADD billingAddress VARCHAR(255) NOT NULL, ADD address VARCHAR(255) NOT NULL, ADD phoneNumber VARCHAR(255) NOT NULL');
    }
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE customers DROP billingAddress, DROP address, DROP phoneNumber');
    }
}
