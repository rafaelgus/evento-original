 ...
 */
class OccasionTranslation extends \EventoOriginal\Core\Entities\OccasionTranslation implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (OccasionTranslation $proxy) {
