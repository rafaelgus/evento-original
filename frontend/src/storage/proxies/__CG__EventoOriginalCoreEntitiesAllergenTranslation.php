 ...
 */
class AllergenTranslation extends \EventoOriginal\Core\Entities\AllergenTranslation implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (AllergenTranslation $proxy) {
