 ...
 */
class Flavour extends \EventoOriginal\Core\Entities\Flavour implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Flavour $proxy) {
     ...
     * {@inheritDoc}
     */
    public function addTranslation(\EventoOriginal\Core\Entities\FlavourTranslation $t)
    {
