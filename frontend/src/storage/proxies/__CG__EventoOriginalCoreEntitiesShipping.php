 ...
 */
class Shipping extends \EventoOriginal\Core\Entities\Shipping implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'method', 'address', 'order'];
        }
     ...
     * {@inheritDoc}
     */
    public function setAddress(\EventoOriginal\Core\Entities\Address $address)
    {
